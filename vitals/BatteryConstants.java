...
public class BatteryConstants {
	...
	static final String HIGH_THRESHOLD_DE="liegt über dem Schwellenwert";
	static final String	HIGH_BREACH_WARNING_DE="ist kurz davor, sich einer hohen Verletzung zu nähern";
	static final String LOW_BREACH_WARNING_DE="ist im Begriff, sich einer geringen Verletzung zu nähern";
